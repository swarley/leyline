...
describe "Leyline.quaggans" do
  ...
  it "returns a hash of quaggans, {id => url}, when a list is provided" do
    ...
    WebMock.stub(:get, Leyline::BASE_URL + "/quaggans?id=scifi")
      .to_return(body: %({"id": "scifi", "url": "scifi-url"}))
    WebMock.stub(:get, Leyline::BASE_URL + "/quaggans?id=404")
      .to_return(body: %({"id": "404", "url": "404-url"}))
